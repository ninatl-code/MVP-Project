...
export default function Signup() {
  ...
  const handleSignup = async () => {
    ...
    try {
      // 1. Create the user account with the primary role
      ...
      // 2. If the user chose both roles, create 2 profiles
      if (authData.user && roles.length === 2) {
        const userId = authData.user.id

        // Create the provider profile (UUID auto-generated by Supabase)
        ...
        if (prestaError) {
          console.error('Error creating provider profile:', prestaError)
        }

        // Create the client profile (UUID auto-generated by Supabase)
        ...
        // 3. If only one role, create a single profile (with id = auth_user_id for compatibility)
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.main}>
          ...
          <Text style={styles.subtitle}>Create your Bricool account</Text>
          ...
          {/* Role Selection */}
          <View style={styles.inputGroup}>
            <Text style={styles.label}>I am: (you can select both)</Text>
            ...
            {roles.length === 2 && (
              ...
              <Text style={styles.bothRolesText}>You will be able to switch between your two profiles in the app</Text>
              </View>
            )}
          </View>
