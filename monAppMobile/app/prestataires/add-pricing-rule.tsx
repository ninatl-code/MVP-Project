...
export default function AddPricingRuleScreen() {
  ...
  const submitRule = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Pricing rule created successfully', [
    ...
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.emptyText}>
          Create an active service before adding pricing rules
        </Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Add Pricing Rule</Text>
        <View style={{ width: 24 }} />
      </View>
        ...
        >
          {submitting ? (
            ...
            <>
              ...
              <Text style={styles.submitButtonText}>Create Pricing Rule</Text>
            </>
          )}
        </TouchableOpacity>
