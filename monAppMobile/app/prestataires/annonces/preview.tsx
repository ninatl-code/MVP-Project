...
export default function AnnoncePreview() {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: `Découvrez cette annonce : ${annonce?.titre}`,
        title: annonce?.titre,
      });
    } catch (error) {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.previewBadge}>
            ...
            <Text style={styles.previewBadgeText}>Mode Aperçu</Text>
          </View>
          ...
          {annonce.profiles && (
            <View style={styles.prestataireCard}>
              ...
              <View style={styles.prestataireInfo}>
                ...
                <Text style={styles.prestataireLabel}>Votre annonce</Text>
              </View>
              {avgRating > 0 && (
...
const styles = StyleSheet.create({
  ...
  errorContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 32, backgroundColor: COLORS.backgroundLight },
  errorText: { fontSize: 18, color: COLORS.text, marginTop: 16, marginBottom: 24, textAlign: 'center' },
  errorButton: { paddingHorizontal: 24, paddingVertical: 12, backgroundColor: COLORS.primary, borderRadius: 8 },
  ...
  shareIconButton: { position: 'absolute', top: 40, right: 16, width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'center', alignItems: 'center' },
  inactiveBadge: { position: 'absolute', top: 100, right: 16, paddingHorizontal: 16, paddingVertical: 8, backgroundColor: COLORS.error, borderRadius: 8 },
  inactiveBadgeText: { color: 'white', fontSize: 14, fontWeight: 'bold' },

  content: { padding: 20, backgroundColor: COLORS.background, marginTop: -20, borderTopLeftRadius: 20, borderTopRightRadius: 20 },

  previewBadge: { flexDirection: 'row', alignItems: 'center', gap: 8, alignSelf: 'center', paddingHorizontal: 16, paddingVertical: 10, backgroundColor: '#DBEAFE', borderRadius: 20, marginBottom: 16 },
  previewBadgeText: { fontSize: 14, fontWeight: '600', color: '#3B82F6' },
  ...
  conditionsBadge: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 8, alignSelf: 'flex-start' },
