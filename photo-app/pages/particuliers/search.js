          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            ...
            <div className="relative flex-1">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:ring-2 focus:ring-gray-300 focus:border-gray-300 focus:outline-none bg-white text-gray-700 font-medium"
              >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                        ...
                        <button 
                          ...
                          className="px-5 py-2.5 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all font-semibold shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
                        >
                          Voir détails →
                        </button>
                      </div>
